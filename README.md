...
Django Web Application with Bootstrap styling

1. Django project and app created
2. Templates extend from base.html
3. Three URLS, Views, and Templates created
   a. Home Page - mwagner.html
   b. Projects Page - projects.html
   c. Contact Page - contact.html
4. Bootstrap styling - text, background, image, navbar, icons, etc.
5. Automated testing 
   a. 4 tests per page
   b. SimpleTestCase
   c. reverse
6. Published to heroku - https://git.heroku.com/cis218-assign-1-mwagner4084.git
...
Issue with reverse testing on contact page - image placed in <h1> rather than text, placed blank text above image to solve problem in the mean time. 

Had issue loading images on heroku site - removed DISABLE_COLLECTSTATIC, problem solved
